<div class="panel panel-default">
  <div class="panel-body">
    <ul class="list-group">
      @foreach($program->organizations as $organization)
        <li class="list-group-item propio-pyme" data-url="{{ route('propio_pyme', [ $entity->id, $item->id, $program->id,$organization->id ]) }}">{{ $organization->name }}</li>
      @endforeach
      </ul>
